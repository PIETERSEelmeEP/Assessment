"""I took 00_Combo_Menu_Base_v2 and added changes to the print full menu
function and format.
"""
import easygui
...
def print_combo_menu():
    ...
    for combo_name, items_prices in Combo_meals.items():
        ...
        for item, price in items_prices.items():
            combo_message += f"{item}: ${price:.2f}\n"
    easygui.msgbox(combo_message, title="Full Combo Menu")


# Welcome & Selected Action Function With farewell and loop
def welcome_selected_action():
    ...
    while True:
        ...
        if choice == "Add":
            ...
            # Farewell Message
            easygui.msgbox("Farewell", title="Farewell")
            return
